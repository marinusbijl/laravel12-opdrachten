            ...
            <div class="p-4">
                <form id="form" class="shadow-md rounded-lg px-8 pt-6 pb-8 mb-4"
                    ...
                    <label class="block text-sm">
                        ...
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="begindate" value="{{ old('begindate') }}" type="datetime-local" required/>
                    </label>
                    <label class="block text-sm">
                        <span class="text-gray-700">Eind datum</span>
                        <input class="bg-gray-200  block rounded w-full p-2 mt-1 focus:border-purple-400
                        focus:outline-none focus:shadow-outline-purple form-input"
                               name="enddate" value="{{ old('enddate') }}" type="datetime-local"/>
                    </label>
                    <label class="block text-sm">
                        <span class="text-gray-700">Activiteit</span>
                        <select
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight
                            focus:outline-none focus:shadow-outline" name="activity_id" id="activity_id">
                    ...
                    <label class="block text-sm">
                        ...
                        <select
                            class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight
                            focus:outline-none focus:shadow-outline" name="project_id" id="project_id">
